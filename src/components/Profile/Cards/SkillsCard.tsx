    ...
    <Card>
      <>
        ...
        <div className="flex flex-wrap gap-3 py-3">
          ...
          <span className="bg-yellow-200 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">
            Java
          </span>
          <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">
          ...
          <span className="bg-yellow-200 text-gray-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">
            AWS
          </span>
        </div>
        <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white flex items-center">
        ...
        <div className="mb-2">
          <a href="mailto:morill30@gmail.com" className="underline">
        ...
        <div className="mb-2">
          <a href="mailto:morillo30@gmail.com" className="underline">
            morillo30@gmail.com
          </a>
        </div>
        <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white flex items-center">
